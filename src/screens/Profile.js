				...
				<div className="row">
					...
					<div className="col-xl-7 font-18 col-lg-5 mt-5 mt-lg-0">
						<p className="mb-0">
							...
							elit. Amet corporis debitis dolore dolores ea facere
							itaque iusto labore magnam maxime nam non obcaecati
							quod quos soluta sunt, totam, ullam? Dolorem.
						</p>
						<p>
							Lorem ipsum dolor sit amet, consectetur adipisicing
							elit. Aliquam aperiam asperiores aspernatur aut
							autem beatae dolores, eligendi illo illum labore
							maxime officiis optio pariatur quaerat qui, quidem
							quisquam rem, soluta!
						</p>
						<br />
						<p>
							Lorem ipsum dolor sit amet, consectetur adipisicing
							elit. Atque beatae commodi deleniti ducimus earum ex
							expedita ipsa laudantium minus modi mollitia nostrum
					...
					<div className="col-xl-2 col-lg-3 pt-5">
						...
						<p className="text-center mb-0">registration date:</p>
			...
			<div className="px-0 px-md-4 position-relative">
				...
				<div className="row">
					<div className="col-lg-4 col-md-6 d-flex flex-column flex-md-row">
						<div className="mr-4">
							<Select type="country" className="left-asterisk" />
							<Select type="region" className="left-asterisk" />
							<Select type="locality" className="left-asterisk" />
						</div>
						<div>
							<Select
								type="nationality"
				...
				<div className="row">
					<div className="col-xl-5 col-lg-6 col-md-12 flex-wrap d-flex flex-column flex-md-row">
						<div className="mr-5">
							...
							<p className="mb-1 no-wrap">Locality: Crestwood</p>
						</div>
						<div>
							<p className="mb-1 no-wrap">
